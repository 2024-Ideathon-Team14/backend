...
// 두 번째 포스트
        ...
        Post secondPost = Post.builder()
            ...
            .createdAt(LocalDateTime.now())
            .requestAt(LocalDateTime.now())
            .latitude(37.34443782447168)
            .longitude(126.74228070048451)
...
// 세 번째 포스트
        ...
        Post thirdPost = Post.builder()
            ...
            .createdAt(LocalDateTime.now())
            .requestAt(LocalDateTime.now())
            .latitude(37.343491048500134)
            .longitude(126.74331603316426)
...
// 네 번째 포스트
        Post fourthPost = Post.builder()
            ...
            .createdAt(LocalDateTime.now())
            .requestAt(LocalDateTime.now())
            .latitude(37.34250623304749)
            .longitude(126.74244347706808)
...
// 다섯 번째 포스트
        ...
        Post fifthPost = Post.builder()
            ...
            .createdAt(LocalDateTime.now())
            .requestAt(LocalDateTime.now())
            .latitude(37.34205937473149)
            .longitude(126.73797622084818)
